...
class TestAIGenerator:
    ...
    def test_generate_response_with_tool_use(self, ai_generator, mock_anthropic_client, mock_tool_use_response, mock_final_response):
        """Test generate_response when AI uses tools"""
        # First call returns tool use, second call returns final response
        mock_anthropic_client.messages.create.side_effect = [mock_tool_use_response, mock_final_response]
    ...
    def test_handle_tool_execution_single_tool(self, ai_generator, mock_anthropic_client, mock_tool_use_response, mock_final_response):
    ...
    def test_handle_tool_execution_multiple_tools(self, ai_generator, mock_anthropic_client, mock_final_response):
    ...
    def test_handle_tool_execution_no_tool_blocks(self, ai_generator, mock_anthropic_client, mock_final_response):
    ...
    def test_generate_response_tool_execution_error_handling(self, ai_generator, mock_anthropic_client, mock_tool_use_response, mock_final_response):
    ...
    def test_sequential_tool_calling_two_rounds(self, ai_generator, mock_anthropic_client):
        ...
        tools = [{"name": "search_course_content", "description": "Search courses"}]
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.side_effect = ["Round 1 result", "Round 2 result"]
    ...
    def test_sequential_tool_calling_max_rounds_limit(self, ai_generator, mock_anthropic_client):
    ...
    def test_handle_tool_execution_with_max_rounds_parameter(self, ai_generator, mock_anthropic_client):
    ...
    def test_backwards_compatibility_single_round(self, ai_generator, mock_anthropic_client, mock_tool_use_response, mock_final_response):
