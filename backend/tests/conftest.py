...
def sample_course():
    ...
    return Course(
        ...
        lessons=[
            Lesson(lesson_number=1, title="What is ML?", lesson_link="https://example.com/ml-course/lesson1"),
            Lesson(lesson_number=2, title="Types of ML", lesson_link="https://example.com/ml-course/lesson2"),
